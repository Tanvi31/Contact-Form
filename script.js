...
form.addEventListener('submit', (e) => {
    ...
    if(firstName === '') {
        ...
        document.querySelector('#first-name').style.border = '1px solid hsl(0, 66%, 54%)'
    } else {
        document.querySelector('#first-name + .form-alert').style.display = 'none'
        document.querySelector('#first-name').style.border = '1px solid hsl(186, 15%, 59%)'
    }
    ...
    if(firstName === '') {
        ...
        document.querySelector('#last-name').style.border = '1px solid hsl(0, 66%, 54%)'
    } else {
        document.querySelector('#last-name + .form-alert').style.display = 'none'
        document.querySelector('#last-name').style.border = '1px solid hsl(186, 15%, 59%)'
    }
    ...
    if(message === '') {
        ...
        document.querySelector('#message').style.border = '1px solid hsl(0, 66%, 54%)'
    } else {
